...
def _prepare_features(train_df: pd.DataFrame, val_df: pd.DataFrame, test_df: pd.DataFrame, config: BaseConfig):
...
def run_base_experiment(
    ...
    vectorizer, x_train, x_val, x_test = _prepare_features(train_df, val_df, test_df, config)
